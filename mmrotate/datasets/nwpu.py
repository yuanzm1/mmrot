...
class NWPUDataset(CustomDataset):
    ...
    """
    class_list = ['airplane', 'bridge', 'ship', 'harbor', 'groundtrackfield', 'vehicle', 'baseball', 'storagetank', 'tenniscourt', 'basketball']

    # CLASSES = random.sample(class_list, 6)#'airport','basketballcourt','groundtrackfield','windmill'  'unknown'
    # CLASSES.append('unknown')
    CLASSES = ['bridge', 'baseball','ship', 'basketball', 'harbor', 'groundtrackfield', 'unknown']
    # true_classes = set()
    ...
    def __init__(self,
        ...
        super(NWPUDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_file):
        ...
        """
        if self.test_all:
            self.CLASSES = ['bridge', 'baseball','ship', 'basketball', 'harbor', 
        ...
        for img_id in img_ids:
            ...
            for obj in root.findall('object'):
                ...
                # self.true_classes.add(class_name)
